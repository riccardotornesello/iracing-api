api_documentation = {
    ...
    "league": {
        ...
        "directory": {
            ...
            "parameters": {
                ...
                "tag": {"type": "string", "note": "One or more tags, comma-separated."},
                "restrict_to_member": {
                    "type": "boolean",
    ...
    "lookup": {
        "club_history": {
            ...
            "parameters": {
                ...
                "season_quarter": {"type": "number", "required": True},
            },
            "expirationSeconds": 900,
        },
        "countries": {
    ...
    "results": {
        ...
        "search_hosted": {
            ...
            "parameters": {
                ...
                "host_cust_id": {"type": "number", "note": "The host's customer ID."},
                "session_name": {
                    "type": "string",
    ...
    "series": {
        ...
        "past_seasons": {
            ...
            "parameters": {"series_id": {"type": "number", "required": True}},
            "expirationSeconds": 900,
        },
        "seasons": {
            "link": "https://members-ng.iracing.com/data/series/seasons",
            "parameters": {"include_series": {"type": "boolean"}},
            "expirationSeconds": 900,
        },
        "stats_series": {
    ...
    "stats": {
        ...
        "season_driver_standings": {
            ...
            "parameters": {
                "season_id": {"type": "number", "required": True},
                "car_class_id": {"type": "number", "required": True},
                "club_id": {"type": "number", "note": "Defaults to all (-1)."},
                "division": {
                    "type": "number",
    ...
    "time_attack": {
        "member_season_results": {
            ...
            "parameters": {"ta_comp_season_id": {"type": "number", "required": True}},
            "expirationSeconds": 900,
        }
    },
    "track": {
